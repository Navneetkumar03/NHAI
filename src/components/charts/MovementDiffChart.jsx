...
export default function MovementDiffChart({
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            setPosition((prev) => ({
                ...
                y: Math.max(
                    0,
                    Math.min(containerRect.height - chartHeight, prev.y),
                ),
            }));
        };
    ...
    const handleMouseMove = useCallback(
        (e) => {
            ...
            newY = Math.max(
                0,
                Math.min(containerRect.height - chartHeight, newY),
            );
    ...
    const displacementDiff = useMemo(() => {
        ...
        return {
            ...
            percentChange:
                ((last.displacement - first.displacement) /
                    Math.abs(first.displacement || 1)) *
                100,
        };
    }, [filteredTimeseries]);
    ...
    return (
        ...
        >
            <div className="p-3 sm:p-4">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            >
                                <X
                                    size={14}
                                    className="sm:w-4 sm:h-4 text-gray-500 hover:text-red-500"
                                />
                            </button>
                        </div>
                    </div>
                ...
                {/* Chart */}
                <div
                    className="h-40 sm:h-48 md:h-56 lg:h-64 w-full"
                    style={{ pointerEvents: "auto" }}
                >
