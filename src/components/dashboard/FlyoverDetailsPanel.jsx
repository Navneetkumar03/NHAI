...
import { getHighwayDetailFields, formatPointName } from "../maps/shared/mapHelpers";

/* ============================================================
   Inlined StatChip (previously in ./StatChip.jsx)
   ============================================================ */
function StatChip({ label, value, valueClassName = "truncate" }) {
    return (
