  ...
  return (
    ...
    >
      <div className="relative rounded-xl2 overflow-hidden shadow-card h-full bg-white">
        ...
        <span
          className={`absolute bottom-2.5 right-2.5 flex items-center gap-1 text-gray-800 text-[10px] sm:text-xs font-bold px-2 sm:px-2.5 py-1 rounded-lg z-[1000] shadow-md ${riskStyles[riskStatus]}`}
        >
          <RiskIcon size={12} />
