...
export default function ObservationInfo({ startDate, endDate, count }) {
    // TODO: hardcoded for now â€” this component currently receives static
    // defaults from DashboardPage. Once the backend API is ready, wire the
    // real values through as props (or fetch them here) instead.
    return (
