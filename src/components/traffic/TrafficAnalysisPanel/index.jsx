...
export function TrafficAnalysisPanel({
  ...
  const {
    ...
    error: trafficError,
    availableDates,
  } = useTrafficData(selectedFlyoverForTraffic, selectedDate);

  useEffect(() => {
    if (
      trafficData?.selected_date &&
      trafficData.selected_date !== "last_24h"
    ) {
      setSelectedDate(trafficData.selected_date);
    } else if (
      trafficData?.available_dates &&
      trafficData.available_dates.length > 0
    ) {
  ...
  function downsample(data, maxPoints = 300) {
    ...
    for (let i = 0; i < data.length; i += bucketSize) {
      ...
      const maxUp = bucket.reduce(
        (m, d) => ((d.up_ratio ?? 0) > (m.up_ratio ?? 0) ? d : m),
        bucket[0],
      );
      const maxDown = bucket.reduce(
        (m, d) => ((d.down_ratio ?? 0) > (m.down_ratio ?? 0) ? d : m),
        bucket[0],
      );
      result.push({
    ...
    >
      ...
      >
        <div style={{ minWidth: 0, flex: 1 }}>
          ...
          >
            Traffic Analysis{" "}
            {displayDate ? ` ${formatDateDisplay(displayDate)}` : "Loading..."}
          </p>
        </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {zoomDomain
                      ? " (Zoomed)"
                      : ` (${dynamicIntervals.find((i) => i.key === selectedInterval)?.label || "Selected Range"})`}
                  </span>
                </div>
                      ...
                      style={{
                        ...
                        color:
                          selectedInterval === interval.key
                            ...
                            : "#6b7280",
                        fontWeight:
                          selectedInterval === interval.key ? "600" : "500",
                        position: "relative",
                        whiteSpace: "nowrap",
                      }}
                    >
                ...
                <div style={{ height: `${chartH}px`, width: "100%" }}>
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      <Legend
                        wrapperStyle={{ fontSize: isMobile ? "7px" : "8px" }}
                      />
                      <ReferenceLine
                        y={1}
                        stroke="#9ca3af"
                      ...
                      <Line
                        ...
                        dot={(props) => {
                          ...
                          return (
                            <circle cx={cx} cy={cy} r={1.5} fill="#3b82f6" />
                          );
                        }}
                        name="Up"
                      />
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: "999px",
                        background:
                          trafficData?.direction_data?.up?.avg_traffic_ratio > 1
                            ? "#fee2e2"
                            : "#dcfce7",
                        color:
                          trafficData?.direction_data?.up?.avg_traffic_ratio > 1
                    ...
                    <div>
                      ...
                      <p
                        style={{
                          ...
                          margin: 0,
                          color:
                            trafficData?.direction_data?.up?.avg_traffic_ratio >
                            1
                              ? "#dc2626"
                              : "#16a34a",
                        }}
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: "999px",
                        background:
                          trafficData?.direction_data?.down?.avg_traffic_ratio >
                          1
                            ? "#fee2e2"
                            : "#dcfce7",
                        color:
                    ...
                    >
                      {trafficData?.direction_data?.down?.avg_traffic_ratio > 1
                        ? "🔴 Traffic"
                        : "✅ Clear"}
                    </span>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {trafficData?.direction_data?.down?.static_duration ||
                          0}
                        s
                      </p>
                    </div>
                    <div>
                      ...
                      <p
                        style={{
                          ...
                          margin: 0,
                          color:
                            trafficData?.direction_data?.down
                              ?.avg_traffic_ratio > 1
                              ? "#dc2626"
                              : "#16a34a",
                        }}
