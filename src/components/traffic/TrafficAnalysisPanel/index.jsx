...
export function TrafficAnalysisPanel({
    ...
    // ⬇️ KEY: fixed compact width on desktop so it doesn't cover half the map
...
//                     alignItems: "center",
//                     gap: "0px",                                  // ⬅ was 2px → 0
//                     padding: isMobile ? "2px 6px" : "3px 8px",   // ⬅ reduced
//                     fontSize: isMobile ? "9px" : "10px",         // ⬅ reduced
//                     borderRadius: "4px",
//                     border: "1px solid #d1d5db",
//                     background: "white",
//                     color: "#1f2937",
//                     cursor: "pointer",
//                     height: isMobile ? "22px" : "24px",          // ⬅ reduced
//                     minWidth: isMobile ? "86px" : "110px",       // ⬅ reduced
//                     justifyContent: "space-between",
//                 }}
//             >
//                 <span style={{
...
//                     textOverflow: "ellipsis",
//                     whiteSpace: "nowrap",
//                     marginRight: "2px",                          // ⬅ tight spacing before icon
//                 }}>
...
//                         flexShrink: 0,
//                         marginLeft: "-1px",                       // ⬅ pull closer to text
//                     }}
//                 />
//             </div>
...
//                 <div style={{
//                     position: "absolute",
//                     top: "calc(100% + 3px)",                      // ⬅ slightly tighter
//                     left: 0,
//                     right: 0,
//                     background: "white",
//                     borderRadius: "6px",
...
//                     border: "1px solid #e5e7eb",
//                     maxHeight: isMobile ? "140px" : maxHeight,
//                     overflowY: "auto",
//                     zIndex: 1000,
//                     minWidth: "120px",                            // ⬅ reduced
//                 }}>
...
//                             }}
//                             style={{
//                                 padding: isMobile ? "5px 10px" : "6px 12px",  // ⬅ reduced
//                                 fontSize: isMobile ? "9px" : "10px",          // ⬅ reduced
//                                 cursor: "pointer",
...
//     // Use the traffic data hook with date parameter
//     const { trafficData, loading: trafficLoading, error: trafficError, availableDates } = useTrafficData(
//         selectedFlyoverForTraffic,
//         selectedDate
//     );

//     // Set the selected date to the date returned from backend when data loads
//     useEffect(() => {
//         if (trafficData?.selected_date && trafficData.selected_date !== "last_24h") {
//             // If backend returns a specific date, use it
//             setSelectedDate(trafficData.selected_date);
//         } else if (trafficData?.available_dates && trafficData.available_dates.length > 0) {
//             // If no selected_date but available dates exist, use the first one (most recent)
//             setSelectedDate(trafficData.available_dates[0]);
//         }
//     }, [trafficData]);

//     // Reset selected date when flyover changes
//     useEffect(() => {
//         setSelectedDate(null);
//     }, [selectedFlyoverForTraffic]);
...
//     // Get the actual selected date to display
//     const getDisplayDate = () => {
//         if (selectedDate) return selectedDate;
//         if (trafficData?.selected_date && trafficData.selected_date !== "last_24h") {
//             return trafficData.selected_date;
...
//     // Function to get 4-hour interval blocks for the selected date
//     const getDateIntervals = () => {
//         const intervals = [];
//         for (let i = 0; i < 6; i++) {
//             const startHour = i * 4;
...
//                 startHour: startHour,
//                 endHour: endHour,
//                 isCurrent: false // No "Current" for historical data
//             });
//         }
//         return intervals;
//     };
...
//             // Check if hour falls within the interval
//             if (interval.startHour >= interval.endHour) {
//                 return hours >= interval.startHour || hours < interval.endHour;
//             } else {
//                 return hours >= interval.startHour && hours < interval.endHour;
...
//                 {/* Date Dropdown - Custom Component */}
//                 {availableDates && availableDates.length > 0 && (
//                     <div style={{
//                         display: "flex",
//                         alignItems: "center",
...
//                         flexShrink: 0,
//                     }}>
//                         <Calendar size={isMobile ? 14 : 16} color="#6b7280" />
//                         <CustomDateDropdown
//                             availableDates={availableDates}
//                             selectedDate={selectedDate || displayDate}
//                             onDateChange={setSelectedDate}
