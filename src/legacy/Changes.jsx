...
import {
    ...
    makeFlyoverIcon,
    formatPointName,
} from "../components/maps/shared/mapHelpers";

import MovementPointsChart from "../components/charts/MovementPointsChart";
import MovementDiffChart from "../components/charts/MovementDiffChart";
...
function getDiffRestingCircleStyle(color, zoom) {
    return {
...
function VelocityDiffLegend({ range }) {
    ...
    return (
        <div className="absolute bottom-3 left-3 z-[1500] bg-white/95 backdrop-blur-sm rounded-md shadow-md border border-gray-200 px-3 py-2 max-w-[220px] max-[480px]:px-2 max-[480px]:py-1.5 max-[480px]:max-w-[150px] max-[480px]:bottom-2 max-[480px]:left-2">
            ...
            {midDiff !== null && (
                <div className="mt-1 text-center text-[9px] text-gray-400 max-[480px]:text-[8px]">
                    mid: {fmt(midDiff)}
                </div>
            )}
        </div>
...
function RiskOverviewPanel({ onClose }) {
    const overviewData = {
